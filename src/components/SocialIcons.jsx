...
const SocialIcons = () => {
  return (
    <>
      {/* Left Side Icons */}
      <div className="fixed top-1/2 left-4 transform -translate-y-1/2 flex lg:gap-28 md:gap-28 sm:gap-0 flex-col space-y-4 z-50">
      ...
      {/* Right Side Icons */}
      <div className="fixed top-1/2 right-4 transform -translate-y-1/2 flex flex-col space-y-4 z-50 lg:gap-28 md:gap-28 sm:gap-0">
