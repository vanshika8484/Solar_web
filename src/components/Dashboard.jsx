...
function Dashboard() {
  ...
  return (
    <motion.div
      className="GetfontHomeDash max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 p-3"
    ...
    >
      ...
      <section className="bg-gray-100 rounded-lg p-3 flex flex-col justify-between min-h-[220px]">
        ...
        <p className="text-3xl font-light text-gray-900 mb-2">5.48</p>
      ...
      {[
        ...
        },
        {
          ...
          values: [
            { label: "Product", value: "3.93" },
            { label: "Consump", value: "7.86" },
          ],
          breakdown: [
        ...
        { title: "Co2", value: "42", subText: "Emissions Saved" },
        { title: "Mi", value: "48", subText: "Driven on Sunshine" },
        { title: "DI", value: "58", subText: "Solar on Rays" },
      ].map((item, index) => (
        <section
          key={index}
