...
const Footer = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="max-w-5xl mx-auto bg-white text-black rounded-2xl shadow-lg p-4 mb-3 flex flex-col md:flex-row items-center justify-between gap-3 mt-10">
      <div className="text-center md:text-left">
        <p className="text-xs text-green-800 font-semibold uppercase">Call us now</p>
      ...
      <div className="flex items-center w-full md:w-auto gap-2">
        <input
          ...
          className="rounded-xl px-3 py-1.5 border border-gray-300 w-full md:w-56 text-sm"
        />
        <button className="bg-green-800 text-white text-sm font-medium px-3 py-1.5 rounded-xl hover:bg-green-700 transition">
          Call Me Back
        </button>
      </div>
    </div>
