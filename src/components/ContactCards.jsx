  ...
  return (
    <div className="bg-white  px-4 sm:px-6 lg:px-8 GetFontSol -mt-[150px]   ">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row gap-6 ">
        ...
        {/* Call Card */}
        <motion.div
          className="relative flex-1 rounded-2xl overflow-hidden min-h-[180px] bg-[#16151a] text-white flex items-center px-6 sm:px-10 shadow-md "
        ...
        >
          ...
          <div className="relative flex items-center gap-5 w-full z-10">
            <div className="flex-shrink-0 rounded-full bg-[#1a191f] w-16 h-16 flex items-center justify-center">
        ...
        {/* Mail Card */}
        <motion.div
          className="relative flex-1 rounded-2xl overflow-hidden min-h-[180px] bg-green-800 text-white flex items-center px-6 sm:px-10 shadow-md"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          />
          <div className="relative flex items-center gap-5 w-full z-10">
            <div className="flex-shrink-0 rounded-full bg-white w-16 h-16 flex items-center justify-center">
              <i className="fas fa-envelope text-green-800 text-xl" />
            </div>
            <div className="flex flex-col text-left">
