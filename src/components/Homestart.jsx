        ...
        >
            <main className="flex flex-col lg:flex-row flex-1 max-w-[1280px] mx-auto w-full px-6 md:px-12 items-center justify-between relative z-10">
                ...
                <div className="max-w-lg mt-16 md:mt-24 lg:mt-32 text-center lg:text-left z-10">
                    ...
                    <button className="bg-[#E50C0C] text-white font-semibold rounded-full py-3 px-8 w-full max-w-[320px] hover:bg-[#2f6f3a] transition">
                ...
                <div className="relative flex-1 h-[500px] sm:h-[600px] md:h-[700px] mt-20 md:mt-32 ig ">
                        ...
                        <img
                            src={solarGlobe}
                            alt="Solar globe"
                            className="absolute ig top-[100px] left-[0px] sm:top-[100px] sm:left-[-50px] md:top-[200px] md:left-[-150px] lg:top-[350px] lg:left-[-125px] scale-[1.8] sm:scale-[1.7] md:scale-[1.8] lg:scale-[1] w-[400px] sm:w-[500px] md:w-[600px] lg:w-[700px] rotating-image z-10"
                        />
 </div>
