...
//                   className={`w-full ${loading ? "bg-gray-400" : "bg-green-800 hover:bg-green-700"
...
//                 <li><strong>Monthly Saving:</strong> ₹{results.monthly_saving}</li>
//                 <li><strong>Net Cost:</strong> ₹{results.net_cost}</li>
//                 <li><strong>ROI:</strong> {results.roi}%</li>
//                 <li><strong>Roof Area:</strong> {results.roof_area} sq. ft.</li>
//                 <li><strong>System Size:</strong> {results.system_size} kW</li>
//                 <li><strong>Total Cost:</strong> ₹{results.total_cost}</li>
//               </ul>
//               <button
