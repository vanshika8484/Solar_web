  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[75%]">
        <div
          className={`px-4 py-3 rounded-2xl text-sm sm:text-base whitespace-pre-line
          ${isRight ? "bg-green-700 text-white rounded-br-none" : "bg-orange-500 text-white rounded-bl-none"}`}
        >
          {typing ? (
